...
public class main extends Activity {
		...
		startServiceBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {	
				...
				if(isSave){
					...
					intent.setClass(main.this, ScreenCapService.class);
					startService(intent);
					...
					Toast.makeText(main.this, "IP's or Port's format is error!£¡", Toast.LENGTH_SHORT).show();
				}
			}
		});
		...
		saveinfoButton.setOnClickListener(new OnClickListener() {	
			...
			public void onClick(View v) {	
				...
				if(IPAddress.equals("") || port.equals("")){
					Toast.makeText(main.this, "IP or port cannot be empty!", Toast.LENGTH_SHORT).show();
					...
					editor.commit();					
					Toast.makeText(main.this, "Save successfully...", Toast.LENGTH_SHORT).show();
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK) {
			AlertDialog.Builder mDialog = new AlertDialog.Builder(main.this);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		{
		case 0:
			Toast.makeText(main.this, "About!", Toast.LENGTH_LONG).show();
			break;
		case 1:
	...
	private void chmodFrameBuffer()
	{

		if(isRoot()){
			java.lang.Process process;
			try {
				process = Runtime.getRuntime().exec("su",null,new File("/dev/graphics/"));
